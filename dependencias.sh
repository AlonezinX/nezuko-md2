...
figlet -c -f slant -t 'ALONE' | lolcat 
...
figlet -c -f slant -t 'NEZUKO|BOT' | lolcat 
...
echo -e " ${CYAN} BEM VINDO(A) AO NEZUKO-MD ${CYAN}sh start.sh"
...
echo "[*] USE SH NEZUKO.SH PARA ESCANEAR O QR"
